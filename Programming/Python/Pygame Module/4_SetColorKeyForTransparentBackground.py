...
def main():
    ...
    #Well, as you can see in the images above, around the "smiley"
    #there is a ugly pink border. Usually you do not want to have 
    #only square sized images in your game. There is a technique 
    #called colorkey that makes one color fully transparent. 
    #The function is quite simple, its called set_colorkey(color):
    #(255,0,255) is the color of background
